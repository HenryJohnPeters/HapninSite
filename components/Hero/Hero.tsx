    ...
    <>
      ...
      <div className="bg-gradient-to-br from-[#70f1ae] to-[#70f1ae] w-full flex flex-col justify-center items-center py-[6rem] sm:py-[3.5rem] px-6 sm:px-10">
        <div className="mx-auto sm:mx-4 md:mx-12 lg:mx-0 lg:w-3/4 2xl:w-[1200px]">
          <div className="flex flex-col sm:flex-row justify-between items-center sm:pt-14 sm:pb-4 md:mb-6 lg:mb-8 2xl:pb-12">
            <div className="flex flex-col justify-center sm:w-1/2 sm:p-2">
              ...
              <span className="font-bold">HAPNIN</span> is an event discovery
              app that offers user-generated events and verified partner events
              in your area. The app&apos;s easy-to-use map-based interface makes
              it simple to find things to do and exclusive discounts. Download
              HAPNIN now to plan your next night out with friends and create
