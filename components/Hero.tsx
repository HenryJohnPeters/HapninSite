...
const Hero = () => {
  return (
    <div className="bg-gradient-to-br from-[#70f1ae] to-[#70f1ae] w-full flex flex-col justify-center items-center py-10 px-6 sm:px-10 lg:px-20">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center sm:py-12">
          <div className="flex flex-col justify-center sm:w-1/2">
            ...
            <p className="text-lg text-black mb-8">
              At <span className="font-bold">HAPNIN</span>, we believe that local events and activities are the heart of any community. That&apos;s why we created our app to help you discover the best free and low cost events in your area.
            </p>
            <button className="bg-white m-4 text-black hover:text-[#70f1ae] hover:bg-black rounded-full py-3 px-6 font-bold shadow-lg transition-all duration-200">
